...
public class FlightsResult {
	...
	public RouteFare getBestPrice() {
		final WebElement outboundFlights = driver.findElement(By
				.className("from-fly-table"));
		final Integer outboundBestFare = selectJourneyBestPrice(outboundFlights);

		final WebElement inboundFlights = driver.findElement(By
				.className("return-fly-table"));
	...
	private Integer selectJourneyBestPrice(final WebElement journeyFlights) {
		final List<WebElement> fares = journeyFlights.findElements(By
				.cssSelector("li.odd"));
		int minFare = 9999;
		...
		for (final WebElement fareElement : fares) {
			...
			final WebElement priceLabel = fareElement.findElement(By
					.cssSelector("label"));
